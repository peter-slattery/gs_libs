...
static void
GrowHeapArena (heap_memory_arena* Arena)
{
...
{
    if (!Arena->CurrentRegion) { GrowHeapArena(Arena); }
    ...
    u8* Result = Arena->CurrentRegion->Base + Size + Offset;
